...
async function setup() {
    ...
    ourTokenContract = new ethers.Contract(ourTokenContractAddress, ourTokenContractAbi, signer);
...
function buyToken(tokenId) {
    ourTokenContract.approve(kittieTraderContractAddress, (1).toString(), {gasLimit: 2500000}).then(() => {
